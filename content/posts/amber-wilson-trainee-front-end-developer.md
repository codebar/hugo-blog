...
![](/images/posts/amber-wilson-trainee-front-end-developer-hero.jpg)

Amber is a trainee front-end developer at [Edenspiekermann](https://www.edenspiekermann.com/) in Berlin. She has been involved with codebar since July 2016. She started as a student, then started organising the Brighton chapter before moving to Berlin and getting involved in that chapter. She is a regular conference attendee and volunteer, most recently helping out [ScotlandJS](http://scotlandjs.com/) & [ScotlandCSS](http://scotlandcss.com/), as well as getting [codebar Berlin](https://codebar.io/berlin) featured as a community partner at [JSConf EU](https://www.jsconf.eu/).
...
I worked at a design agency in Brighton as a development intern where I got to grips with Angular, SCSS, sprint planning, user experience, JavaScript and all that good agency stuff. It was there that I discovered just how much I still had to learn. But, I also learned I could find plenty of support if I needed it, and every developer no matter how experienced, still feels that they have way too much to learn.
...
I plan to become a JavaScript expert. Haha, just kidding. That doesn't exist. But I do plan to keep working hard, being present in the tech community, creating personal projects and improving my skills — both development skills and working well in an agile team setting.
...
[Amber Wilson — Trainee front-end developer](https://medium.com/codebar-stories/amber-wilson-trainee-front-end-developer-66aa3a2fe4f4) was originally published in [codebar stories](https://medium.com/codebar-stories) on Medium, where people are continuing the conversation by highlighting and responding to this story.
