...
![](/images/posts/beverley-newing-front-end-developer-hero.jpg)

Beverley is currently Front End Developer at Oxford Computer Consultants, she is one of those codebar greats who started attending as a student then came back as a coach, and has now started a new chapter in Oxford after moving there for an internship. She also won the Rising Star Award at the 2017 [We Are the City Awards](https://twitter.com/WATC_Updates).
...
Despite having been interested in more STEM-oriented subjects, I actually then went down a humanities route. I didn't do very well at Higher Level maths (the I.B. equivalent of a Further Maths A-Level) and so instead of Physics, decided to go and study English and German Literature, subjects that I was better at. But I realised at university that it was close reading that I'd really enjoyed, and looking at patterns and grammar, and that my degree didn't involve a lot of that. After I left university, I floated for 6 months and then got an internship at [Code First: Girls](http://www.codefirstgirls.org.uk/), where I learnt a huge range of skills including coding. From there, I then moved to another internship with [Zooniverse](https://www.zooniverse.org/) at the University of Oxford, where I studied JavaScript and build tools, and then got another internship after that at [Oxford Computer Consultants](https://www.oxfordcc.co.uk/) where I focused on my Front End skills. As of the 1st of June I now work there as a Front End Dev!
...
Definitely [Zooniverse](https://www.zooniverse.org/)! The team was fantastic, and the impact it has on research is amazing. It's such a cool platform — and it's an open source project so anyone can contribute!
...
[Beverley Newing — Front End Developer](https://medium.com/codebar-stories/beverley-newing-front-end-developer-669300f30d45) was originally published in [codebar stories](https://medium.com/codebar-stories) on Medium, where people are continuing the conversation by highlighting and responding to this story.
